...
public sealed class ProofreadIssue
{
    ...
    public string DocumentKind { get; set; } = SakuyaTranslator.Core.Models.DocumentKind.Txt;
}
...
public sealed class ProofreadBatchItem
{
    ...
    public string DocumentKind { get; init; } = SakuyaTranslator.Core.Models.DocumentKind.Txt;
}
